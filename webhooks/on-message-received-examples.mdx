...
<Accordion title="Grupo suspenso">
```json
{
  "chatLid": null,
  "isGroup": true,
...
<Accordion title="Suspensão do grupo removida">
```json
{
  "chatLid": null,
  "isGroup": true,
  ...
  "forwarded": false,
  "type": "ReceivedCallback",
  "notification": "GROUP_UNSUSPENDED",
  "notificationParameters": [],
  "callId": null,
  "code": null,
}
...
<Accordion title="Proteção Anti-Golpe em Grupos de Avisos">
```json
{
  "isGroup": true,
