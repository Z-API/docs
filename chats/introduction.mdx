...
<CardGroup cols={2}>
  ...
  <Card title="Metadata do chat">
    Busque informações detalhadas de um chat específico.
  </Card>
...
|------|---------------|---------|
| Contato | Número de telefone | `5511999999999 ou 99999999999@lid` |
| Grupo | ID do grupo | `120363019502650977-group ou 123456789101-12345678910` |
