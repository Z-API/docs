...
description: "Retorna os produtos do catálogo de qualquer número (V2 com paginação via body)"
---
...
Nesse método você será capaz de pegar os produtos de um catálogo do WhatsApp Business de qualquer número, sendo o seu catálogo ou de outra pessoa. Esta versão utiliza POST com paginação via body.
