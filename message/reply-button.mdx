---
title: "Responder texto com botões"
api: "POST /instances/{instanceId}/token/{token}/reply-button"
description: "Responde um botão de lista de botões como se o usuário tivesse clicado"
---
...
Este endpoint permite responder um botão de lista de opções, simulando o clique do usuário em uma das opções enviadas anteriormente via [send-button-list](/message/send-button-list).
...
<div style={{ display: "flex", justifyContent: "center" }}>
  <img src="/images/reply-button.jpeg" width="400" />
</div>
