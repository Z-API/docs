...
api: "POST /instances/{instanceId}/token/{token}/update-group-description"
...
Este método é responsável por alterar a descrição de um grupo.
...
<ParamField body="groupDescription" type="string" required>
