...
<Warning>
Ao criar um novo grupo, é necessário utilizar exclusivamente números de telefone. A identificação @lid não é compatível e não permitirá a criação do grupo.
</Warning>
