...
- Dificuldade ao iniciar novas conversas  
...
Esse comportamento pode dar a impressão de instabilidade, mas na verdade é uma restrição temporária aplicada ao número.
...
- ❌ Solicitar desbloqueio ao WhatsApp  

Na maioria dos casos, o ideal é apenas aguardar.

### Tempo de duração

Não há um prazo exato definido para a duração do shadowban. Em geral, a restrição dura alguns dias, após os quais o número volta a funcionar normalmente.

Ao conectar o número no WhatsApp Web e tentar iniciar uma nova conversa, pode aparecer um aviso informando o tempo restante da restrição.
