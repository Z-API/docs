...
description: "Ativa ou desativa a leitura automática de todas as mensagens recebidas pela API"
---
...
![Leitura automática no painel](/images/auto-read.jpeg)
...
<ParamField body="value" type="boolean" required>
  `true` para ativar a leitura automática ou `false` para desativar
</ParamField>
