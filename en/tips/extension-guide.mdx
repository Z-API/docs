...
Go to the Chrome Web Store and install the **Z-API Conector** extension:
...
1. Open **https://web.whatsapp.com/** in Chrome, logged in with the number you want to connect to the Z-API instance
...
This new authentication was developed to comply with WhatsApp's phone-based authentication requirement. The Z-API Conector extension ensures this process is carried out securely and integrated with your instance, without exposing sensitive credentials.

Always generate a new token whenever you need to reconnect the instance, as each token has a limited validity period.
